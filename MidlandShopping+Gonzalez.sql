...
-- Crear la tabla Devolución
CREATE TABLE Devolución (
    DevoluciónID INT AUTO_INCREMENT PRIMARY KEY,
    VentaID INT,
    ProductoID INT,
    Cantidad INT NOT NULL,
    Fecha DATETIME NOT NULL,
...
CREATE TABLE Ubicación (
    UbicaciónID INT AUTO_INCREMENT PRIMARY KEY,
    Nombre VARCHAR(100) NOT NULL,
...
CREATE TABLE Promoción (
    PromociónID INT AUTO_INCREMENT PRIMARY KEY,
    Nombre VARCHAR(100) NOT NULL,
